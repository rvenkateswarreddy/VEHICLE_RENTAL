      ...
      <div className="mb-6">
        <div className="flex space-x-4 mb-4">
          ...
          >
            ...
            <option value="5 hr 20 kms">5 Month</option>
          </select>
        </div>
      </div>
        ...
        filteredBookings.map((booking) => (
          ...
          >
            <div className="w-full p-6">
              ...
              <p className="text-gray-700 mb-2">Location: {booking.location}</p>
              <p className="text-gray-700 mb-2">
            ...
            <div className="w-[100%]">
              <img
                src={booking.vehicle_id.image_url} // Replace with `booking.vehicle_id.image` if available
                alt={`${booking.vehicle_id.make} ${booking.vehicle_id.model}`}
